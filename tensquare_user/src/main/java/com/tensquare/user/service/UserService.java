...
public class UserService {
	 ...
	 * @param num
	 */
	public void addFansCount(String userid,int num){
		userDao.addFansCount(userid, num);
	}
	 ...
	 * @param num
	 */
	public void addFollowCount(String userid,int num){
		userDao.addFollowCount(userid, num);
	}
	...
	public User login(User user){
		...
		if(byMobile!=null&&encoder.matches(user.getPassword(),byMobile.getPassword())){
